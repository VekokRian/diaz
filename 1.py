...
cl = LINETCR.LINE()
#cl.login(qr=True)
cl.login(token='Ergb1ayWs7wftM9LXpYb.VKQ9Jq2o+6hoVXBJ0l/fgW.nBDXMYFOsT81oF2DOS38lTfdNZD+ahtD1bZ0yzbdpEE=')
cl.loginResult()
print "Cl-Login Success\n"

#ki = LINETCR.LINE()
#ki.login(qr=True)
#ki.login(token='Ergb1ayWs7wftM9LXpYb.VKQ9Jq2o+6hoVXBJ0l/fgW.nBDXMYFOsT81oF2DOS38lTfdNZD+ahtD1bZ0yzbdpEE=")
#ki.loginResult()
#print "Ki-Login Success\n"

#kk = LINETCR.LINE()
#kk.login(qr=True)
#kk.login(token='Ergb1ayWs7wftM9LXpYb.VKQ9Jq2o+6hoVXBJ0l/fgW.nBDXMYFOsT81oF2DOS38lTfdNZD+ahtD1bZ0yzbdpEE=")
#kk.loginResult()
#print "Kk-Login Success\n"

#kc = LINETCR.LINE()
#kc.login(qr=True)
#kc.login(token='Ergb1ayWs7wftM9LXpYb.VKQ9Jq2o+6hoVXBJ0l/fgW.nBDXMYFOsT81oF2DOS38lTfdNZD+ahtD1bZ0yzbdpEE=")
#kc.loginResult()
#print "Kc-Login Success\n"

#kr = LINETCR.LINE()
#kr.login(qr=True)
#kr.login(token='Ergb1ayWs7wftM9LXpYb.VKQ9Jq2o+6hoVXBJ0l/fgW.nBDXMYFOsT81oF2DOS38lTfdNZD+ahtD1bZ0yzbdpEE=")
#kr.loginResult()
#print "Kr-Login Success\n"

#km = LINETCR.LINE()
#km.login(qr=True)
#km.login(token='Ergb1ayWs7wftM9LXpYb.VKQ9Jq2o+6hoVXBJ0l/fgW.nBDXMYFOsT81oF2DOS38lTfdNZD+ahtD1bZ0yzbdpEE=")
#km.loginResult()
...
╚═════════════════════════
"""
tjia="ube4abd8d0d8effa1cebf16e3d0bf851b"
	 ...
	 if wait["Ghost"] == True:
          if op.param2 in admin:
           if op.param2 in Bots:
            ...
            try:
              ...
              km.acceptGroupInvitationByTicket(op.param1,Ticket)
              time.sleep(0.01)
              km.kickoutFromGroup(,͡➴͜͡Įইเαɳ͜͡͡➴[͡➴͜͡Įইเαɳ͜͡͡➴])
              c = Message(to=op.param1, from_=None, text=None, contentType=13)
              c.contentMetadata={'mid':͡➴͜͡Įইเαɳ͜͡͡➴}
              km.sendMessage(c)
              km.leaveGroup(op.param1)
              G.preventJoinByTicket = True
              cl.updateGroup(G)
        ...
        if op.type == 26:
			...
			cl.sendText(msg.to,"Admin Detected~")
                ...
                msg.contentType = 13
                msg.contentMetadata = {'mid': "ube4abd8d0d8effa1cebf16e3d0bf851bl}
                cl.sendMessage(msg)
		cl.sendText(msg.to,"Itu Owner Saya (^_^)")
		
            elif msg.text in ["Admin","admin"]:
                msg.contentType = 13
                admin1 = "ube4abd8d0d8effa1cebf16e3d0bf851b"
                admin2 = "ube4abd8d0d8effa1cebf16e3d0bf851b"
                admin3 = "ube4abd8d0d8effa1cebf16e3d0bf851b"
...
#		    cl.sendText(msg.to,"Khusus Nadya")
		...
		if midd not in admin:
		    ...
		    cl.sendText(msg.to,"Admin Detected")
                ...
                midd = "ube4abd8d0d8effa1cebf16e3d0bf851b"
                random.choice(KAC).inviteIntoGroup(msg.to,[midd])
